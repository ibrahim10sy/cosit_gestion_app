...
class _DayPageState extends State<DayPage> {
  ...
  Future<List<Procedure>> getProcedure() async {
    ...
    final response = await procedureService.getDepenseTotalByJour();
    setState(() {
        ...
        child: Column(
          children: [
                ...
                : SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: PaginatedDataTable(
                        header: const Text('Les dépenses par jour'),
            ...
            Padding(
              ...
              child: Center(
                child: Text(
                  "DÉPENSES TOTAL PAR CATÉGORIE PAR JOUR",
                  style: TextStyle(
                    fontSize: 17,
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    ...
                    width: 70,
                    child: FutureBuilder(
                      future: procedureService.getDepenseTotalByJour(),
