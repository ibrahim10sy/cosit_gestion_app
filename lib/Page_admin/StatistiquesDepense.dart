...
class _StatistiqueState extends State<Statistique>
  ...
  void initState() {
    ...
    setState(() {
      Column(
          ...
          children: procedures
              .map((e) =>
                  _buildLegendItem(e.libelle, _getColorFromCategory(e.libelle)))
              .toList());
    });
  ...
  Future<List<Procedure>> getProcedure() async {
    final response =
        await procedureService.getDepenseByCategory(admin.idAdmin!);
    return response;
  }
                                ...
                                SizedBox(
                                  ...
                                  child: FutureBuilder(
                                    future: procedureService
                                        .getDepenseByCategory(admin.idAdmin!),
  ...
  Color _getColorFromCategory(String libelle) {
    switch (libelle) {
      ...
      case 'Autres':
        return Color.fromARGB(255, 223, 72, 185);
      default:
