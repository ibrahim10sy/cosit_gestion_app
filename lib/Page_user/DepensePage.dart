                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const AjoutDepense()));
                      },
                      child: const Text(
                        "+ Ajouter une depense",
                        ...
                        if (depenseService.lastAction !=
                          ...
                          return FutureBuilder(
                              future: depenseService.action == "all"
                                  ? depenseService.fetchDepensesByUser(
