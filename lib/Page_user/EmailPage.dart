...
class EmailPageUser extends StatefulWidget {
  const EmailPageUser({super.key});

  @override
  State<EmailPageUser> createState() => _EmailPageUserState();
}

const d_red = Colors.red;

class _EmailPageUserState extends State<EmailPageUser> {
  ...
  Future<List<SendNotification>> getNotif() async {
    final response =
        await SendNotifService().fetchData(utilisateur.idUtilisateur!);
    return response;
  }
                            ...
                            return FutureBuilder(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  if (!snapshot.hasData) {
                                    ...
                                    return Column(
                                      children: listeNotif.where((element) => element.demande.autorisationAdmin == true)
                                          .map(
                                                                      ...
                                                                      (value) =>
                                                                          {
                                                                            ...
                                                                            setState(() {
                                                                              futureNotifications = SendNotifService().fetchData(utilisateur.idUtilisateur!);
                                                                            }),
